...
function loadResource(config, url) {
    return new Promise((resolve, reject) => {
        localforage_default().ready()
            .then(() => {
                localforage_default().getItem(`${CACHE_PREFIX}${url}`)
                    .then(value => {
                        if (value === null) {
        ...
        axios_default().get(url, options)
            .then(response => {
                ...
                if (response.status >= 400) {
                    ...
                    if (config.cache) {
                        localforage_default().setItem(`${CACHE_PREFIX}${url}`, response.data)
                    }
...
;// CONCATENATED MODULE: ./node_modules/pokeapi-js-wrapper/src/installSW.js
function installSW() {
...
;// CONCATENATED MODULE: ./node_modules/pokeapi-js-wrapper/src/config.js
class Config {
    constructor(config={}) {
        this.protocol = 'https'
...
;// CONCATENATED MODULE: ./node_modules/pokeapi-js-wrapper/src/index.js
...
class Pokedex {
    ...
    constructor(config) {
        ...
        endpoints_namespaceObject.forEach(endpoint => {
        ...
        rootEndpoints_namespaceObject.forEach(rootEndpoint => {
    ...
    getCacheLength() {
        return localforage_default().length()
    }

    clearCache() {
        return localforage_default().clear()
    }
...
;// CONCATENATED MODULE: ./src/assets/pokedex/pokedex.js
...
window.Pokedex = __webpack_require__(700)
